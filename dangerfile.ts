...
jestCodecov(
  ...
  `https://circleci.com/api/v1.1/project/github/${process.env.CIRCLE_PROJECT_USERNAME}/${process.env.CIRCLE_PROJECT_REPONAME}/latest/artifacts?circle-token=${process.env.CIRCLE_TOKEN}&branch=master`
)
